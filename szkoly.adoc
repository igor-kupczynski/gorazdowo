...
monograficznym "Ziemia wrzesińska" rok 1695. Druga data to rok 1828, która
znajduje się w kronice szkolnej. Początkowo nie miała własnego budynku.
Zamierzano postawić budynek na krzyżówce do Gałęzewic obok wiatraka ob.
Antoniego Kaniewskiego. Szkoła ta miała obejmować rejon wsi Szamarzewo, Borkowo,
Dąbrowa i Gałęzewo. Grunt pod budowę szkoły dawał dziedzic, a miejscowi rolnicy
mieli ponieść koszt budowy. Gospodarze uznali, że jest to dla nich krzywdzące i
nie zgodzili się na tę koncepcję. Wówczas dziedzic oddał na szkołę budynek
osadniczy (wybudowany w 1803 r.) i ziemię. Budynek ten nie bardzo nadawał się do
tego celu, stąd po komisyjnym zbadaniu go w 1835 r. opracowano kosztorys
przebudowy opiewający na kwotę 288 talarów 25 srebrnych groszy i 3 denary.
Szkoła miała 40 stóp długości 30 2/3 stopy szerokości. Wybudowana była z gliny i
posiadała 1 izbę lokacyjną. Ponieważ stary budynek gospodarczy groził zawaleniem
— Poznań udzielił w 1886 r. zezwolenia na budowę nowego obiektu. Budynek ten
pozostał do dnia dzisiejszego (obecna stodoła), pokryty był słomą.
